...
![Um projeto Scratch com uma ventoinha, uma luz e uma caixa para digitar](images/whatyouwillmake.gif)
...
Este projeto possui duplo licenciamento sob a [Licença Creative Commons Attribution Non-Commercial Share-Alike](http://creativecommons.org/licenses/by-nc-sa/4.0/){:target="_blank"} e a [Versão de Licença Apache 2.0](http://www.apache.org/licenses/LICENSE-2.0){:target="_blank"}.
